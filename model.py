...
class DGCNN_semseg_xyz(nn.Module):
    def __init__(self, args):
        super(DGCNN_semseg_xyz, self).__init__()
        self.args = args
        self.k = args.k
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(6, 64, kernel_size=1, bias=False), ## change to 12 from 18
                                   self.bn1,
                                   nn.LeakyReLU(negative_slope=0.2))
        self.conv2 = nn.Sequential(nn.Conv2d(64, 64, kernel_size=1, bias=False),
                                   self.bn2,
        ...
        self.conv8 = nn.Sequential(nn.Conv1d(512, 256, kernel_size=1, bias=False),
                                   ...
                                   nn.LeakyReLU(negative_slope=0.2))
        self.dp1 = nn.Dropout(p=args.dropout)
        self.conv9 = nn.Conv1d(256, 3, kernel_size=1, bias=False) ## change to 7 from 13
...
class DGCNN_semseg_am(nn.Module):
    def __init__(self, args):
        super(DGCNN_semseg_am, self).__init__()
        self.args = args
        self.k = args.k
        ...
        self.conv8 = nn.Sequential(nn.Conv1d(512, 256, kernel_size=1, bias=False),
                                   ...
                                   nn.LeakyReLU(negative_slope=0.2))
        self.dp1 = nn.Dropout(p=args.dropout)
        self.conv9 = nn.Conv1d(256, 2, kernel_size=1, bias=False) ## change to 7 from 13
